...
public class TutorialScript : MonoBehaviour
{
    ...
    void Start()
    {
        //проверяем необходимость туториала
        if (isTutorialNeeded)
        {
    ...
    void LateUpdate()
    {
        ...
        //если игрок собрал дерево, то теперь он должен идти к споту
        ...
        //как только игрок собрал первый сконвертированный ресурс, он отправляется в основную игру, ведь туториал закончился
